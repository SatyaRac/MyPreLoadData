...
import com.example.mypreloaddata.prefs.AppPreference;
...
public class LoadDataAsyc extends AsyncTask<Void, Integer, Boolean> {
    private final String TAG = LoadDataAsyc.class.getSimpleName();
    ...
    LoadDataAsyc(MahasiswaHelper mahasiswaHelper, AppPreference preference, LoadDataCallback callback, Resources resources) {
